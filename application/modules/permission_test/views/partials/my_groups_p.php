...
//alert('about to send this url:\n index.php/permission_test/groups/remove_from_group/<?=$this->session->userdata['logged_in']['userid']?>/'+groupid);	
...
//			url: 'permission_test/join_group/',
			url: 'permission_test/groups/remove_from_group/<?=$this->session->userdata['logged_in']['userid']?>/'+groupid,
			type: 'get',
//			data: values,
