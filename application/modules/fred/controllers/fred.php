...
////////////////////////////////////////////////////////////////////////
	...
	function xml_to_html($xml = null, $resource_id = null, $group_id = null, $function)
	{
		if($xml !== null)
		...
		switch($data['xml_obj']->attributes()->type)
		{
			...
			case 'xml/file':
				...
				break;
			default:
				echo 'I don\'t know what\'s happening';
		}	
	}
////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////
...
';
		$this->xml_to_html($xml, $resource_id, $group_id, $function);
	}
