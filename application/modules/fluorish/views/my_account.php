...
<div class="heading-buttons">
  <h3><span class="icon64 icomoon-icon-myfluorish"></span>My Fluorish</h3>
          ...
          <div class="row-fluid">
            <div class="span6">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" value="Royce" class="span10" />
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" value="Cano" class="span10" />
              ...
              <div class="control-group">
                ...
                <div class="controls"> 
                  <input type="text" value="Tree Star" class="span10 institutions" />
