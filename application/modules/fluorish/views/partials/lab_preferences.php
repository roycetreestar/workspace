...
<div class="widget widget-2 widget-tabs widget-tabs-2 tabs-right border-bottom-none">
  <div class="widget-head">
    <ul>
      <li class="active"><a class="glyphicons user" href="#lab-details" data-toggle="tab"><i></i>Lab Information</a></li>
...
<div class="innerLR">
  <div class="tab-content"> 
    ...
    <!-- lab-details tab --> 
    <div class="tab-pane active" id="lab-details">
      <!-- -->
      <div class="widget widget-2">
        <div class="widget-head">
          <h4 class="heading glyphicons edit"><i></i>Lab Name</h4>
        </div>
    ...
    <!-- lab-members tab -->
    <div class="tab-pane" id="lab-members"> 
      <!-- -->
      <div class="widget widget-2">
        <div class="widget-head">
              ...
              <div class="widget-timeline">
                <table class="table table-bordered table-condensed">
                  <thead>
                      ...
                      <th class="center">&nbsp;</th>
                      <th class="center">&nbsp;</th>
                      <th class="center" colspan="3">Inventory</th>
                      <th class="center">&nbsp;</th>
                      <th class="center">&nbsp;</th>
                      <th class="center">&nbsp;</th>
                    </tr>
                    <tr>
                      ...
                      <th class="center">Full Access</th>
                      <th class="center">Modify Amount Only</th>
                      <th class="center">View Only</th>
                      <th class="center">Orders Require Manager Approval</th>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="center"><input type="radio" name="RadioGroup1" value="radio" id="RadioGroup1_0" /></td>
                      <td class="center"><input type="radio" name="RadioGroup1" value="radio" id="RadioGroup1_1" /></td>
                      <td class="center"><input type="radio" name="RadioGroup1" value="radio" id="RadioGroup1_2" /></td>
                    ...
                    <tr>
                      ...
                      <td class="center"><input type="radio" name="RadioGroup2" value="radio" id="RadioGroup2_0" /></td>
                      <td class="center"><input type="radio" name="RadioGroup2" value="radio" id="RadioGroup2_1" /></td>
                      <td class="center"><input type="radio" name="RadioGroup2" value="radio" id="RadioGroup2_2" /></td>
                      <td class="center"><input type="checkbox" checked="unchecked" /></td>
                      <td class="center"><input type="checkbox" checked="unchecked" /></td>
                      <td class="center"><a href=""class="btn btn-small">Remove</a></td>
                    </tr>
                    <tr>
                      ...
                      <td class="center"><input type="radio" name="RadioGroup3" value="radio" id="RadioGroup3_0" /></td>
                      <td class="center"><input type="radio" name="RadioGroup3" value="radio" id="RadioGroup3_1" /></td>
                      <td class="center"><input type="radio" name="RadioGroup3" value="radio" id="RadioGroup3_2" /></td>
                      <td class="center"><input type="checkbox" checked="unchecked" /></td>
                      <td class="center"><input type="checkbox" checked="unchecked" /></td>
                      <td class="center"><a href=""class="btn btn-small">Remove</a></td>
                    </tr>
