...
<div class="tab-pane active well" id="tabAll">
  <div id="accordion-1" class="accordion accordion-2">
...
<!-- widget header -->		
      <div class="accordion-heading dashboard">
        <div class="row-fluid accordion-header">
			<div class="span8 group-title"> 
				<a href="#group-<?=$group_id?>" data-parent="#accordion" data-toggle="collapse" class="accordion-toggle glyphicons group-type-<?=$group_type?>"><i></i>
					<h3> <?= $group_name?><span> <?= $permission?> </span></h3>
				</a> 
			</div>
			<div class="span4 right group-resources">
				...
				<?php
					if($p)
					{
				?>		<a href="panels/list_view/<?=$group_id?>" class="btn-icon glyphicons cogwheel" data-toggle="tooltip" data-placement="top" data-original-title="Panels">
							Panels
							<i></i>
						</a> 
				<?php
      ...
      <div class="row-fluid accordion-toggle">
        <div class="span2 offset10 right"> <span class="pull-right"> <a href="#group-<?=$group_id?>" data-parent="#group-<?=$group_id?>" data-toggle="collapse" id="toggle-1" class="accordion-toggle"><i class="g1 icon-chevron-up"></i> Details</a></span> 
...
<?php
	$this->load->view('membership/partials/group_resources_p');
?>
				</div>
