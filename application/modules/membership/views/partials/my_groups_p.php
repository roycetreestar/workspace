...
//alert('about to send this url:\n membership/groups/remove_from_group/<?=$this->session->userdata['logged_in']['userid']?>/'+groupid);	
...
//			url: 'membership/join_group/',
			url: 'membership/groups/remove_from_group/<?=$this->session->userdata['logged_in']['userid']?>/'+groupid,
			type: 'get',
//			data: values,
