<ul class="breadcrumb">
	...
	<li class="divider"></li>
	<li><?php echo $translate->_('tables'); ?></li>
</ul>
<div class="separator bottom"></div>

<h3 class="glyphicons table"><i></i><?php echo $translate->_('Dynamic Tables'); ?></h3>
<div class="innerLR">
	<div class="widget widget-4">
		<div class="widget-head">
			<h4 class="heading">DataTables Simple Example</h4>
		</div>
	...
	<div class="widget widget-4 widget-body-white">
		<div class="widget-head">
			<h4 class="heading">DataTables with TableTools example</h4>
		</div>
		<div class="widget-body">
...
<div class="code visible separator top">
...
<h3 class="glyphicons show_thumbnails"><i></i> <?php echo $translate->_('tables_classic'); ?></h3>
<div class="innerLR">
...
<h3 class="glyphicons show_thumbnails"><i></i> <?php echo $translate->_('tables_themed'); ?></h3>
<div class="innerLR">
	<div class="widget widget-4">
		<div class="widget-head">
