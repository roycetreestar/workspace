...
<h3 class="glyphicons magic"><i></i><?php echo $translate->_('Form Wizards'); ?></h3>
<div class="innerLR">
	...
	<div class="wizard">
		<div class="widget widget-2 widget-tabs widget-wizard-pills">
	...
	<div id="rootwizard" class="wizard">
		...
		<div class="widget widget-2">
			...
			<!-- Wizard Progress bar -->
			<div class="widget-head progress progress-primary margin-none" id="bar">
