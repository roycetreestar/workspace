...
<h3 class="glyphicons show_thumbnails_with_lines"><i></i> <?php echo $translate->_('form_validator'); ?></h3>
<form class="form-horizontal" id="validateSubmitForm" method="get" autocomplete="off">
