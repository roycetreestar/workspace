...
<div class="heading-buttons">
	<h3 class="glyphicons shopping_cart"><i></i> <?php echo $translate->_('products'); ?></h3>
...
<div class="menubar">
	<ul>
		<li><a href=""><?php echo $translate->_('add_product'); ?></a></li>
		<li><a href=""><?php echo $translate->_('manage_categories'); ?></a></li>
		<li class="divider"></li>
...
<h4 class="heading-arrow margin-bottom-none">Category name</h4>
...
<div class="innerLR">
	<div class="separator top form-inline small">
		<div class="pagination pagination-small pull-left" style="margin: 0;">
			<ul>
				<li class="disabled"><a href="#">&laquo;</a></li>
				<li class="active"><a href="#">1</a></li>
				<li><a href="#">2</a></li>
		...
		<div class="pull-right">
			<span class="pull-left" style="padding: 0 5px;"><?php echo $translate->_('total_products'); ?>: 26</span>
