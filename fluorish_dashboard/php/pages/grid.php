<ul class="breadcrumb">
	...
	<li class="divider"></li>
	<li><?php echo $translate->_('Grid'); ?></li>
</ul>
<div class="separator bottom"></div>

<h3 class="glyphicons show_thumbnails"><i></i>12 Column Fluid Grid</h3>
<div class="innerLR">
	<!-- 2 Column / Half -->
	<div class="widget widget-4">
		...
		<div class="widget-head">
			<h4 class="heading">2 Column / Half</h4>
		</div>
		<!-- // Widget heading END -->
...
<!-- // Code sample END -->
	...
	<div class="widget widget-4">
		...
		<!-- Widget heading -->
		<div class="widget-head">
			<h4 class="heading">3 Column / One Third</h4>
		</div>
		<!-- // Widget heading END -->
...
<!-- // Code sample END -->
	...
	<div class="widget widget-4">
		...
		<!-- Widget heading -->
		<div class="widget-head">
			<h4 class="heading">2 Column / One Third &amp; Two Third</h4>
		</div>
		<!-- // Widget heading END -->
...
<!-- // Code sample END -->
	...
	<div class="widget widget-4">
		...
		<!-- Widget heading -->
		<div class="widget-head">
			<h4 class="heading">4 Column / One Fourth</h4>
		</div>
		<!-- // Widget heading END -->
...
<!-- // Code sample END -->
	...
	<div class="widget widget-4">
		...
		<!-- Widget heading -->
		<div class="widget-head">
			<h4 class="heading">2 Column / One Fourth &amp; Three Fourth</h4>
		</div>
		<!-- // Widget heading END -->
