...
<div class="heading-buttons">
	<h3 class="glyphicons show_thumbnails"><i></i><?php echo $translate->_('Tabs'); ?> <span>in 8 awesome styles</span></h3>
...
<div class="innerLR">
	...
	<div class="widget widget-2 widget-tabs widget-tabs-2">
		...
		<span class="btn btn-toggle-code btn-mini btn-primary btn-icon glyphicons embed_close" data-toggle="hide" data-target="#code-20"><i></i> Source</span>
	</div>
	<!-- // Tabs END -->
	
<!-- Code sample -->
<div class="code hide" id="code-20">
...
<!-- // Code sample END -->
	...
	<!-- Tabs -->
	<div class="widget widget-2 widget-tabs widget-tabs-double-2">
...
<!-- // Code sample END -->
	...
	<div class="box-generic">
		...
		<div class="tabsbar tabsbar-2">
			<ul>
				<li class="glyphicons cargo active"><a href="#tab1-4" data-toggle="tab"><i></i> Product Listing</a></li>
				<li class="glyphicons circle_info"><a href="#tab2-4" data-toggle="tab"><i></i> <span>Product Details</span></a></li>
				<li class="glyphicons cart_in"><a href="#tab3-4" data-toggle="tab"><i></i> <span>Shopping Cart</span></a></li>
				<li class="glyphicons pencil"><a href="#tab4-4" data-toggle="tab"><i></i> <span>Shop Management</span></a></li>
			</ul>
		</div>
		<!-- // Tabs Heading END -->
...
<!-- // Code sample END -->
	...
	<!-- Tabs -->
	<div class="widget widget-tabs widget-tabs-double widget-tabs-vertical row-fluid">
...
<!-- // Code sample END -->
	...
	<div class="widget widget-tabs-icons-only">
		...
		<!-- Widget Heading -->
		<div class="widget-head">
			<h4 class="heading">Tabs from Icons</h4>
