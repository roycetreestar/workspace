<ul class="breadcrumb">
	...
	<li class="divider"></li>
	<li><?php echo $translate->_('FAQ'); ?></li>
</ul>
<div class="separator bottom"></div>

<h3 class="glyphicons comments"><i></i>Frequently Asked Questions</h3>
<div class="innerLR">
...
<h3 class="glyphicons google_maps"><i></i>Contact</h3>
<div class="innerLR">
	<div class="row-fluid">
		<div class="span7">
			<h4 class="separator bottom margin-none">Send us a message</h4>
