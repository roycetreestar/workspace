<ul class="breadcrumb">
	...
	<li class="divider"></li>
	<li><?php echo $translate->_('my_account'); ?></li>
	<li class="divider"></li>
	<li><?php echo $translate->_('Advanced profile'); ?></li>
</ul>
<div class="separator bottom"></div>

<h3 class="glyphicons user"><i></i><?php echo $translate->_('Advanced profile'); ?></h3>
<div class="innerLR">
	...
	<div class="widget widget-2 widget-tabs widget-tabs-2 border-bottom-none">
		...
		<div class="widget-body innerT innerLR-none">
					...
					<div class="tab-pane active widget-body-regular" id="overview">
						...
						<div class="row-fluid">
							<div class="span3 center">
								...
								<!-- Profile Photo -->
								<a href="" class="thumb"><img data-src="holder.js/200x150/dark" alt="Profile" /></a>
								<div class="separator bottom"></div>
								<!-- // Profile Photo END -->
							...
							<div class="span9">
								...
								<p>Curabitur quis dui orci. Ut nisi dolor, dignissim a aliquet quis, vulputate id dui. Proin ultrices ultrices ligula, dictum varius turpis faucibus non. Curabitur faucibus ultrices nunc, nec aliquet leo tempor cursus.</p>
								<!-- // About END -->
								...
								<div class="row-fluid">
									...
									<div class="span6">
										...
										<div class="widget widget-4">
											...
											<!-- Widget Heading -->
											<div class="widget-head">
												<h4 class="heading"><?php echo $translate->_('Widget'); ?></h4>
											</div>
											<!-- // Widget Heading END -->
							...
							<div class="widget-body span9">
								...
								<div class="row-fluid">
									...
									<div class="span6">
										...
										<label><?php echo $translate->_('first_name'); ?></label>
										...
										<label><?php echo $translate->_('last_name'); ?></label>
										...
										<label><?php echo $translate->_('date_of_birth'); ?></label>
									...
									<div class="span6">
										...
										<label><?php echo $translate->_('gender'); ?></label>
										<select class="span12">
										...
										<label><?php echo $translate->_('age'); ?></label>
								...
								<label><?php echo $translate->_('about_me'); ?></label>
									...
									<div class="row-fluid">
										...
										<div class="span9">
											...
											<div class="input-prepend">
												...
												<input type="text" id="inputWebsite" class="input-large" placeholder="http://www.fluorish.com" />
											</div>
											<div class="separator"></div>
