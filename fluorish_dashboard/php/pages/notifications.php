<ul class="breadcrumb">
	...
	<li class="divider"></li>
	<li><?php echo $translate->_('Components'); ?></li>
	<li class="divider"></li>
	<li><?php echo $translate->_('Notifications'); ?></li>
</ul>
<div class="separator bottom"></div>

<h3 class="glyphicons message_in"><i></i>Notyfy <span>Notifications plugin</span></h3>
<div class="innerLR">
	...
	<div class="row-fluid">
		...
		<div class="span4">
			<div class="widget widget-4">
				...
				<div class="widget-body center">
					<span class="btn btn-default btn-small" data-layout="topLeft" data-type="primary" data-toggle="notyfy">Top</span>
					<span class="btn btn-default btn-small" data-layout="centerLeft" data-type="primary" data-toggle="notyfy">Center</span>
					<span class="btn btn-default btn-small" data-layout="bottomLeft" data-type="primary" data-toggle="notyfy">Bottom</span>
				</div>
			</div>
		</div>
		...
		<div class="span4">
			<div class="widget widget-4">
				...
				<div class="widget-body center">
					<span class="btn btn-default btn-small" data-layout="topRight" data-type="primary" data-toggle="notyfy">Top</span>
					<span class="btn btn-default btn-small" data-layout="centerRight" data-type="primary" data-toggle="notyfy">Center</span>
					<span class="btn btn-default btn-small" data-layout="bottomRight" data-type="primary" data-toggle="notyfy">Bottom</span>
				</div>
			</div>
		</div>
	...
	<div class="row-fluid">
		...
		<div class="span8">
			<div class="widget widget-4">
				...
				<div class="widget-body center">
					<span class="gritter-add-sticky btn btn-default btn-block btn-icon glyphicons right_arrow"><i></i><strong>Add sticky notification</strong>&nbsp;<span>Has to be manually removed</span></span>
					...
					<span class="gritter-add-white btn btn-default btn-block btn-icon glyphicons right_arrow"><i></i><strong>Add white notification</strong>&nbsp;<span>Has a "gritter-light" class applied</span></span>
					<span class="gritter-add-max btn btn-default btn-block btn-icon glyphicons right_arrow"><i></i><strong>Add notification with max. of 3</strong>&nbsp;<span>Only if there are less than 4 messages already on screen</span></span>
				</div>
			</div>
		</div>
