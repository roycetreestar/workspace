...
var charts = 
{
		...
		website_traffic_toolbar: function()
		{
			...
			$('#websiteTraffic24Hours').click(function()
			{
				charts.website_traffic_graph.plot.setSelection(
				{
					xaxis: 
					{
						from: charts_data.graph24hours.from,
						to: charts_data.graph24hours.to
					}
				});
			});
			...
			$('#websiteTraffic7Days').click(function()
			{
				charts.website_traffic_graph.plot.setSelection(
				{
					xaxis: 
					{
						from: charts_data.graph7days.from,
						to: charts_data.graph7days.to
					}
				});
			});
			...
			$('#websiteTraffic14Days').click(function()
			{
				charts.website_traffic_graph.plot.setSelection(
				{
					xaxis: 
					{
						from: charts_data.graph14days.from,
						to: charts_data.graph14days.to
					}
				});
			});
		},
	...
	{
		// data
		d1: charts_data.website_traffic.d1,
		d2: charts_data.website_traffic.d2,
